...
| `excess_mortality_cumulative`          | Cumulative excess mortality P-scores for all ages; see https://github.com/owid/covid-19-data/tree/master/public/data/excess_mortality for the definition of the P-score and how we calculate it                                            |
| `excess_mortality_cumulative_absolute` | Cumulative excess mortality for all ages; see https://github.com/owid/covid-19-data/tree/master/public/data/excess_mortality for the definition of the P-score and how we calculate it                                                     |
