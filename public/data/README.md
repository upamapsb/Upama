...
| `population`                 | Population (latest available values). See                                                                                                                                                                                                  |
|                              | https://github.com/owid/covid-19-data/blob/master/scripts/input/un/population_latest.csv for full list of sources                                                                                                                          |
